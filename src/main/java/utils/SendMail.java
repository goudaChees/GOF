...
public class SendMail {
	...
	public SendMail(String useremail, String emailTitle, String emailContents) {
		// 호스트와 계정정보. 보내는 계정(SMTP 설정이 된 계정)
		String host = "smtp.naver.com";
		String user = "realishy@naver.com";
		String password = "london0000";
		...
		// 메일 내용
			message.setText("문의내용 : "+ emailContents +"   [[ 유저id : 비회원 "+"     유저email :"+useremail+" ]]");
