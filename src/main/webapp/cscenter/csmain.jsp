								...
								<div class="accordion-item">
									<h2 class="accordion-header" id="panelsStayOpen-headingTwo">
										<button class="accordion-button collapsed" type="button"
											...
											aria-expanded="false"
											aria-controls="panelsStayOpen-collapseTwo">Q 게시판 이용
											방법이 궁금해요!</button>
									</h2>
									<div id="panelsStayOpen-collapseTwo"
										...
										<div class="accordion-body">
											...
											물어보세요! <br> 고민하는 물건의 사진을 한장 찍어서 업로드 하면 끝! <br> <a
												href="#">지출의 참견 바로가기</a> <br><br> <strong>선택의 참견
												>> </strong> <br> 지금 이 가격 맞나? 고민 되신다면!? <br> 숨은 고수들이 더 싼곳을
											찾아주실거에요! <br> 경매를 시작하고! 낙찰까지 진행해보세요. 숨은 혜택이 있을지도!? <a
												href="#"><br>선택의 참견 바로가기</a> <br>
										</div>
									</div>
								</div>
								<br> <br>
								...
								<div class="accordion-item">
									<h2 class="accordion-header" id="panelsStayOpen-headingThree">
										<button class="accordion-button collapsed" type="button"
											...
											aria-expanded="false"
											aria-controls="panelsStayOpen-collapseThree">Q 댓글이
											안써져요!</button>
									</h2>
									<div id="panelsStayOpen-collapseThree"
										...
										<div class="accordion-body">
											댓글이 안써지는 경우는 크게 두가지로 나뉩니다. <br> <strong>1. 회원
												가입을 해주세요! </strong> <br> 회원가입의 절차는 매우 빠르답니다. 회원가입을 진행해 주세요! <br>
											<a href="/joinform.member">회원 가입 하러 가기</a> <br> <br> <strong>2.
												댓글을 이미 다셨어요! </strong> <br> 혹시 댓글을 이미 다신 것은 아니신가요? <br> 저희는
											한 컨텐츠에 한개의 댓글만 작성할 수 있답니다! <br>
