...
/>
									...
									<div style="display:inline-block; border:0px" id="${i.seq}">${i.good }</div>
								</div >
								<div  style="display:none">
									<svg  class="goodcencel_path" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-hand-thumbs-up-fill" viewBox="0 0 16 16">
									...
									<div style="display:inline-block; border:0px" id="c${i.seq}">${i.good }</div>
								</div>
							</div>
						</div>
					</form>
...
//          0. 날짜 변환(오늘날짜는 시간, 전날은 연,월,일 표시)
			...
			// 베스트 댓글 
			if(${glist}[0].good>0){
				let best = $("<img src='/img/best2.png' style='width:20px'>")
